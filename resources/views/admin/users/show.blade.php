            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <section class=" my-10 max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:h-48">
                    ...
                    <div>
                        ...
                        <form action="{{route('admin.user.remove.role' , [$user->id , $role_permission->id])}}" method="POST" class="text-red-600 inline hover:underline">
                            @csrf 
                            @method('DELETE')
                ...
                <section class=" my-10 max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 md:h-48">
                    <h1 class="text-gray-800 "> permissions</h1>
                    <div>
                        @foreach ($user->permissions as $role_permission)
                        <form action="{{route('admin.users.revoke.permission' , [$user->id , $role_permission->id])}}" method="POST" class="text-red-600 inline hover:underline">
                            @csrf 
                            @method('DELETE')
                            <button type="submit">{{$role_permission->name}}</button>
                        </form>
