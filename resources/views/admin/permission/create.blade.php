                    ...
                    <div class="flex items-center justify-center pb-6 md:py-0 md:w-1/2">
                        <form action="{{route('admin.permission.store')}}" method="POST">
                            ...
                            <div class="flex flex-col p-1 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
                                <input class="px-6 py-2 text-gray-700 placeholder-gray-500 bg-white outline-none border-none focus:border-none focus:placeholder-transparent dark:focus:placeholder-transparent focus:outline-none" type="text" name="name" placeholder="Enter your Permission" >
